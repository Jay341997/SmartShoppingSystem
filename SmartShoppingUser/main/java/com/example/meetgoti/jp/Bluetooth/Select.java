package com.example.meetgoti.jp.Bluetooth;
...
import com.example.meetgoti.jp.MainActivity;
import com.example.meetgoti.jp.R;
import com.example.meetgoti.jp.StartShopping;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(Select.this, StartShopping.class);
                i.putParcelableArrayListExtra( "Products", Products );
